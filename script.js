document.addEventListener('DOMContentLoaded', function() {
    ...
    const batteryData = {
        ...
        'Ni-Cd': { voltageStart: 1.2, voltageEnd: 1, type: 'Ni-Cd', selfDischargeRate: 12, description: 'Nickel-Cadmium rechargeable chemistry. Self-discharge: 10-15% per month at room temperature. Enter capacity at 25°C.' },
        'Ni-MH': { voltageStart: 1.2, voltageEnd: 1, type: 'Ni-MH', selfDischargeRate: 6, description: 'Nickel-Metal Hydride rechargeable chemistry. LSD type: ~6% per month. Standard type: up to 50% in first month. Enter capacity at 25°C.' },
